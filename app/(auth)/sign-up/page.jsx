    ...
    <div className="w-full max-w-md p-8 bg-white border border-gray-200/80 rounded-2xl shadow-xl space-y-6 animate-in fade-in zoom-in-95 duration-200" suppressHydrationWarning>
      <div className="text-center space-y-2" suppressHydrationWarning>
        ...
        <p className="text-sm text-gray-500">
          Get started with FinSight to manage your finances with AI insights.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3.5" suppressHydrationWarning>
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full h-11 flex items-center justify-center gap-2 bg-violet-600 hover:bg-violet-700 text-white font-medium text-sm rounded-xl shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-1 disabled:opacity-60 pt-1"
        >
          {loading ? (
            <>
